...
import { ADVERTISEMENT_SERVICE, AUTH_SERVICE, EMAIL_SERVICE, HOUSE_SERVICE, INVOICE_SERVICE, ROOM_SERVICE, ROOMSERVICE_SERVICE, SERVICEPACKAGE_SERVICE, SUPPORTREQUEST_SERVICE, TENANT_SERVICE, USER_SERVICE } from '../constants/injection/injection.constant';
